  ...
  <div data-role="content">
    ...
    <ul data-role="listview" data-split-icon="gear" data-filter="true">
      <g:each in="${patientInstanceList}" status="i" var="patientInstance">
        <li>
        <g:link action="show" id="${patientInstance.id}">${patientInstance}</g:link>
        <g:link action="edit" id="${patientInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
        </li>
      </g:each>
      </ol>
